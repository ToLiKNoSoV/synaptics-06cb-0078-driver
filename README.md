...
fprintd версии 1.94.5 требует libfprint версии 1.94.9 или новее. Драйвер собран с libfprint 1.94.10, что удовлетворяет этому требованию, но fprintd не может отпечатки пальцев из-за архитектурных ограничений.
